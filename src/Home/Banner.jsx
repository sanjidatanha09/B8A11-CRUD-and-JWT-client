                    ...
                    <div className="absolute flex items-center  h-full left-0  top-0 bg-gradient-to-r from-[#151515] to-[rgba(21,21,21,0)]">
                        <div className='text-white space-y-7 pl-10 w-[300px] md:w-[500px]  lg:w-[870px] my-10'>
                            ...
                            <div className='flex gap-4 mt-5 text-white'>
                                <button className='btn btn-warning text-white text-xs lg:text-xl'>Discover More</button>
                                <button className='btn btn-warning text-white  btn-outline text-xs  lg:text-xl'>Latest  Iteams</button>
