    ...
    return (
        <div>
            <div className="md:h-[50vh] lg:h-[50vh] mb-10">
                <div class="flex  justify-center items-center flex-col md:h-[50vh] lg:h-[50vh] image-full shadow-xl bg-base-100 rounded-2xl ">
                    <div class="w-full bg-[url('https://i.ibb.co/cDLLW0s/french-restaurant-background-food-concept-french-cuisine-serving-cafe-548821-14104.jpg')] bg-cover bg-center rounded-2xl">
